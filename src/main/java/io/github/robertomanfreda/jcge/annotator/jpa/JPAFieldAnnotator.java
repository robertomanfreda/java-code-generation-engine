...
/**
 * JPAFieldAnnotator is a concrete implementation of AbstractAnnotator
 * to handle the addition of JPA annotations to a JavaPoet FieldSpec.Builder.
 */
public class JPAFieldAnnotator extends AbstractAnnotator<FieldSpec.Builder> {

    private final JsonNode fieldProps;

    /**
     * Constructs a new JPAFieldAnnotator.
     *
     ...
     */
    public JPAFieldAnnotator(GenerationDetails generationDetails, FieldSpec.Builder fieldBuilder, JsonNode fieldProps) {
        super(generationDetails, fieldBuilder);
        this.fieldProps = fieldProps;
    }

    /**
     * Retrieves the JsonNode containing JPA annotation details for the field.
     *
     * @return the JsonNode with JPA annotation information
     */
    @Override
    protected JsonNode getNode() {
        return fieldProps.path("jpa");
    }
